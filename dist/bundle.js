 ...
 */
        ...
        function rt(e, t, n) {
            var r = $e(e), i = (!v.boxSizingReliable() || n) && "border-box" === C.css(e, "boxSizing", !1, r), o = i,
        ...
        var Lt = /%20/g, Ht = /#.*$/, Ot = /([?&])_=[^&]*/, Pt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Rt = /^(?:GET|HEAD)$/,
            Mt = /^\/\//, It = {}, Wt = {}, Ft = "*/".concat("*"), Bt = x.createElement("a");
    ...
    var r = n(0), i = n.n(r);
    i()((function () {
        i()("li:odd").css("backgroundColor", "violet"), i()("li:even").css("backgroundColor", (function () {
            return "#E35265"
        }))
    }))
}]);